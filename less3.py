...
class Human:
    ...
    def live(self, day):
        ...
        if self.pet is None:
            ...
            print(f"{self.name} got a pet named {self.pet.name}!")

        self.days_indexes(day)

        # Pet interaction every few days
        if day % 5 == 0:
            print("Time to play with the pet!")
            self.pet.play()
        elif day % 3 == 0:
            print("Time to feed the pet!")
            self.pet.feed()
        self.pet.pet_status()
...
class Pet:
    ...
    def feed(self):
        print(f"You fed your pet {self.name}.")
        self.hunger += 10
        if self.hunger > 100:
            self.hunger = 100
    ...
    def pet_status(self):
        print(f"Pet {self.name} -- Happiness: {self.happiness}, Hunger: {self.hunger}")
